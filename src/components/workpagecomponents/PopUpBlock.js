 ...
 ${image1 ? `
                     <figure slot="pop-up-image">
                        ...
                        <div class="pop-up-image-container">
                            <img class="pop-up-image" style="user-select: none;
  -webkit-user-drag: none;" src="${image1}" alt="">
                        </div>
                     ...
                     <figure slot="pop-up-image">
                        <div class="pop-up-image-container">
                            <img class="pop-up-image" style="user-select: none;
  -webkit-user-drag: none;" src="${image2}" alt="">
                        </div>
                     ...
                     <figure slot="pop-up-image">
                        <div class="pop-up-image-container">
                            <img class="pop-up-image" style="user-select: none;
  -webkit-user-drag: none;" src="${image3}" alt="">
                        </div>
